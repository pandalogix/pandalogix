...
CREATE INDEX [IX_AccountPad_PadId] ON [AccountPad] ([PadId]);

GO

CREATE INDEX [IX_AccountPad_UserId] ON [AccountPad] ([UserId]);
...
VALUES (N'20181129041934_init', N'2.1.2-rtm-30932');
